...
- **话术**：系统在阿里云上调用 AI 工作流，分 4 步生成内容。这个过程大概需要 1 分钟。
- **目的**：体现 AI 能力和产品差异化
...
- 工作流接入
- 可演示 MVP
**参考回答**（30 秒）：我完成了完整的前后端系统。前端是原生 HTML/CSS/JS，包含左右分栏布局、4 个输出卡片、Loading 进度条和复制功能。后端是 Node.js + Express，封装了 API 调用层。整个产品从输入到输出 1 分钟内可以演示。
